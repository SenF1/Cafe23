...
class ShiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  # test "should not be able to end shift in the same minute as start time" do
  #   logout_admin
  #   login_employee
  #   shift_today_for_ralph = FactoryBot.create(:shift, assignment: @assign_ralph_2, date: Date.current, start_time: Time.local(2000,1,1,(Time.now.hour),0,0,), end_time: nil, status: 2)
  #   time = shift_today_for_ralph.start_time + 30.seconds
  #   patch time_out_path, params: { time: time }
  #   assert_equal "Unable to end shift ( please wait at least 1 minute after shift started )", flash[:alert]
  #   assert_redirected_to home_path
  # end
